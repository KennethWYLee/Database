...
- [Student-facing GitHub preview](https://github.com/KennethWYLee/Database/tree/student-preview)
...
- `working_materials/student_sqlite_package/`: SQLite lab allow-list, package builder,
  and approved ZIP.
- `working_materials/student_repository/`: builds the simplified chapter-based student
  repository preview and its single course schedule.
...
created later from the verified preview after instructor approval. The private
`student-preview` branch is a derived review copy, not a maintained source or public
release. Historical materials, textbooks, assessments, answers, grading records, and
unverified sources remain private.
