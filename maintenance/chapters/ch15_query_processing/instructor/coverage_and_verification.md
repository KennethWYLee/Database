...
- Official slide deck `from_11001_DB/PowerPoint Presentations/ch15.pdf`, all 59 PDF
  pages.
...
scans; join order; nested-loop and indexed nested-loop concepts; and query-plan
evidence. Merge/hash join comparison and materialization versus pipelining are
extensions.
...
| C15.05 | nested/indexed nested-loop | 15.5.1-15.5.3, pp. 704-708; slides 15.27, 15.29, 15.31-15.33 | department-course join | identify outer/inner access |
...
| C15.08 | materialization/pipelining (supplementary) | 15.7.1-15.7.2, pp. 724-730; slides 15.50-15.56 | filter-join-project flow | identify ORDER BY blocking work |
...
```powershell
py -3 maintenance/chapters/ch15_query_processing/instructor/verify_ch15.py
```
...
- Files created: student guide, SQL lab, instructor source/alignment record, and
  verifier.
- Source verification: complete for textbook printed pages 689-735 and all 59 pages
