...
Learn database design, SQL, normalization, storage, indexing, and query processing
through diagrams and small examples.

## Course Materials

One notebook per chapter. Today: this syllabus, [Ch1](ch01.ipynb), and [Ch2](ch02.ipynb) only.
Then follow Ch3-9 and Ch14-19 in order. Available [Ch3](ch03.ipynb), [Ch5](ch05.ipynb), and [Ch8](ch08.ipynb)
are for their scheduled meetings, not today's work.
...
**Scope:** Sections 4.1-4.7 and Sections 9.1-9.2 are required.
Ch8 covers selected algebra, not calculus. Ch14-19 use selected concepts and small
worked examples, not complete proofs or implementations. Ch20 is not scheduled.

## Assessment

| Assessment | Weight | Scope |
|---|---:|---|
| Written Exam 1 | 30% | Ch1-6: taught introduction, ER/EER, relational model, and basic SQL |
| Written Exam 2 | 30% | Ch7-9 and Ch14-15: taught SQL, algebra, mapping, normalization, and decomposition |
| Written Exam 3 (Final Examination) | 30% | Ch16-19 (selected); cumulative taught SQL and design |
