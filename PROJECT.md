...
2026-09-24 依教師commit、push授權，更新已核准公開的Ch4中文導覽為40頁。
先以校園案例說明身分、任命及授課，再用圖書館案例重新運用概念；各案例
先交代背景、資料與規則，再比較圖示、反例與修正。原有來源與全頁渲染檢查
見本機維護紀錄；本次發布副本不改內容，僅更新頁數與SHA256發布測試。
SHA256：a1e0adf4b9a131fb0b26756918a8537e2896b77927c00a5800654613eb5434ed。
本次unittest discover共70項，63通過、7項依既有來源限制略過；公開清單、
PDF頁數與SHA檢查通過。PDF無附件或註解，常見本機路徑／憑證字樣無命中。
其他中文導覽（含Ch5）、私人維護來源及私人分支歷史不加入公開版本。
課綱、評量及其他已發布教材與習題解答不變。下方37頁紀錄是前一版。

2026-09-24 教師另行核准公開Ch4中文導覽。新增
Intro DB/DB_ch04_中文導覽.pdf（37頁）及首頁閱讀連結，更新allow-list與發布測試。
此授權只涵蓋Ch4中文導覽；其他中文導覽、維護來源、翻拍原檔及私人分支
歷史仍不公開。課綱、評量、既有教材與習題解答不變。
發布PDF與已驗證本機版本逐位元相同，SHA256：
1ccb016b90a7e61908dc64907ccd819769af347b8a9ac86fabcec9b6ea6abe55。
發布檢查：PDF無附件或註解；全文常見本機路徑／憑證字樣掃描無命中。
unittest discover（test_*.py）成功：70項測試，回報7項略過，原因為已下架
Ch3 notebook PDF或未發布來源；README連結、公開清單與PDF雜湊檢查通過。
本次沒有改教材內容，也不是重新進行完整教科書查核。以下私人限制的歷史
紀錄對此份Ch4中文導覽由本次明確授權取代，其他檔案限制維持。

2026-09-24 同步教師核准的教材整理：Ch3只保留圖解教材與既有習題解答，
移除重複的ch03.ipynb、ch03.pdf，修正README、課綱入口與建置清單。
Ch1-2教材及Ch2-7習題解答不變，課程範圍、日期與評量不變。
15章中文導覽只更新私人Drive，不加入本公開分支或其提交歷史。
本次發布從既有公開版本獨立提交，不合併私人備課分支。

2026-09-20 後續教師明確授權「習題允許所有授課章節」並要求解答放到GitHub。
此授權只擴大習題解答：一般教材仍只公開Ch1-3，中文備課稿與翻拍原檔維持私人。
題號、條件與指定圖表以學生翻拍版本為準；目前只有Ch2-7翻拍來源。
本次新增Ch2(15題)、Ch5(20題)、Ch6(16題)、Ch7(9題)英文解答，共69頁；
Ch3(35題/55頁)、Ch4(33題/62頁)沿用已核對版本，Ch4解答恢復公開。
Ch1、Ch8-9、Ch14-19缺少翻拍題目，未假用另一份PDF替代，也未宣稱全部完成。
公開入口在README的Exercise Answers；課綱、考試範圍與配分不變。
新答案維護來源在private_references/semester_answers，來源與QA仍為ignored本機資料。
80項新內容/SQL檢查、Ch3的19項及Ch4的27項既有檢查通過；新PDF全頁render、
題號、邊界、來源hash及重建一致性檢查通過。這不是全書逐句查核或教師審閱。
Ch3-4原生建模軟體lab仍未實機完成，PDF保留概念解答與限制說明。
發布仍從origin/main的獨立工作樹進行，不推送私人備課分支或其歷史。
主要下一步：補齊缺少章節的習題頁與被引用圖表，才能完成其餘章節解答。
