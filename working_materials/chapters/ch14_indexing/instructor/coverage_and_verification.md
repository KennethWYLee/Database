...
```powershell
node working_materials/chapters/ch14_indexing/instructor/render_ch14_diagram.js
py -3 working_materials/chapters/ch14_indexing/instructor/verify_ch14.py
```
