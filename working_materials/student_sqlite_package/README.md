...
```powershell
py -3 working_materials/student_sqlite_package/build_package.py --verify
```

The build creates:

```text
working_materials/student_sqlite_package/output/sqlite_course_package/
working_materials/student_sqlite_package/output/sqlite_course_package.zip
```
...
- `working_materials/sql_labs/university_db/`, whose publication provenance has not
  been confirmed;
